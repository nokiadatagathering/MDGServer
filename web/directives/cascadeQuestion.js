define(function () {
  ...
  return function ($compile) {
    return {
            ...
            if (text) {
              ...
              if ($.isEmptyObject($scope.cascades[$scope.selectedOption])) {
                if (!checkRepeatedOptions(value)) {
                  ...
                  $scope.cascades[$scope.selectedOption] = makeCacadeChild($scope.selectedOption, { text: text, value: value });
                  $scope.newOption = {};
                  $scope.showAddOption = false;
                } else {
      ...
      templateUrl: '/partials/templates/cascadeQuestion.html'
    };
  };
});
