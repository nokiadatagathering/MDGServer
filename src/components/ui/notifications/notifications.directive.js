angular.module('mdg.ui.notifications', [])
  ...
  function () {
    ...
    return {
      ...
      template: '<div><div class="notifications__event" ng-repeat="event in events" nf-event="event" ng-class="{red: event.red}"></div></div>'
    };
  }
);