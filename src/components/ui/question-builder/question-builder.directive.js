angular.module('mdg.ui.questionBuilder', [])

  .directive('questionBuilder',
  function () {
    'use strict';
    return {
      restrict: 'A',
      ...
      controller: [
        '$scope', '$element', '$attrs', '$rootScope', '$compile',
        function ($scope, $element, $attrs, $rootScope, $compile) {
      ...
      templateUrl: 'components/ui/question-builder/question-builder.html'
    };
  }
);
